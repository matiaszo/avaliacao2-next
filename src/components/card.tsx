        ...
        <>
             <div className="flex flex-col min-w-80 max-w-80 justify-center items-center border-2 rounded-md">
                    <div className="flex h-96 w-full relative items-center justify-center">
                      ...
                      <Image src={image} alt="imagem do personagem" className="w-auto h-[110%] object-scale-down ease-in-out duration-500 hover:scale-125 z-10" width={1000} height={1000} priority/>
                    </div>
